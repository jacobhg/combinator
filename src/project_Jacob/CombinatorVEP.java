...
public class CombinatorVEP {
    ...
    // Vector en el que tenemos las líneas de cabecera correspondientes a los campos del fichero obtenido de VEP y que se incluirán 
    // como líneas de cabecera en el fichero de salida:
    public final String[] vep_header_lines = {
     ...
     */
    private void addVepToVcf(File vcf_file, File vep_file, File output_file) throws IOException, FileNotFoundException{
        ...
        // Fichero de salida en el que tendremos las líneas del fichero .vcf con la adición de los campos de VEP como 
        ...
        while (vcf_line != null){
            ...
            while (vep_line != null){
                // Almacenamos en un vector los campos del fichero VEP de la línea leída:
                ...
                // lo que tendremos que dividir esa línea para quedarnos con la posición que nos interesa (la primera de las dos
                // posiciones, en el caso del ejemplo sería 1394663):
                String[] vep_pos = vep_chrom_pos[1].split("-");
                
                // Comprobar que el cromosoma y la posición de .vcf y VEP sean los mismos:
                ...
                // Caso 2: Si el cromosoma (CHROM) es diferente en ambos ficheros.
                    ...
                    // Caso 2.2: Si el cromosoma (CHROM) del fichero .vcf es mayor que el del fichero VEP, avanzamos en el fichero VEP 
        ...
        while (vcf_line != null){
            ...
            while (vcf_line.startsWith("#")){
                ...
                if (vcf_line.startsWith("##INFO")){
                    ...
                    // del campo INFO para la información de VEP:
                    for (int i = 0; i < vep_header_lines.length; i++){
                        print_out.println(vep_header_lines[i]);
                    }
                }
     ...
     * VEP, donde la clave del map será el acrónimo o nombre corto que representa el campo y el valor será el valor del 
     * propio campo.
        ...
        for (int i = 0; i < vep_fields.length; i++){
            ...
            if (indexOfVepField(vep_headers[i]) >= 0){
                ...
                if (!(vep_fields[i].equals("-"))){
                    // Comprobamos si es un campo correspondiente a la frecuencia en la población para guardar solamente 
                    // el valor de la frecuencia y no guardar el alelo alternativo, ya que los campos de la frecuencia son
                    // del tipo "A:0.198699": 
     ...
     */
    public String generateOutputInfoField (){
